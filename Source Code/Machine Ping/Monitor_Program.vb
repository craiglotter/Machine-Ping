...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label5.Text = "Number of Failed Pings:"
        '
        'Label3
        '
...
#End Region
    ...
    Public Sub WorkerProgressHandler(ByVal value As Integer)
        Try
            ...
            Label12.Text = Format(Now(), "dd/MM/yyyy hh:mm:ss tt")
    ...
    Private Sub run_worker()
        ...
        Worker1.targetnames = targetnames
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Try
            ...
            NotifyIcon1.Text = "Checking Pinging Remote Machines..."
    ...
    Private Sub Label13_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label13.Click
        force_check()
    End Sub
